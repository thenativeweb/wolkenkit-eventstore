  ...
  (0, _createClass2.default)(Eventstore, [{
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee3(_ref2) {
        ...
        var url, namespace, _getParts, host, port, user, password, database, connection, createUuidToBinFunction, createUuidFromBinFunction, query;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 18:
                ...
                if (_context3.t0.message.includes('FUNCTION UuidToBin already exists')) {
                  _context3.next = 22;
                  break;
                }
              ...
              case 28:
                ...
                if (_context3.t1.message.includes('FUNCTION UuidFromBin already exists')) {
                  _context3.next = 32;
                  break;
                }
